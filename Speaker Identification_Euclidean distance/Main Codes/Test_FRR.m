...
for k=threshold
    ...
    mismatch_cnt
    FRR(kk) = (mismatch_cnt/ (Number_of_person*Signals_Per_person))*100;                  
    TSR(kk) = (match_cnt/ (Number_of_person*Signals_Per_person))*100;      
    kk=kk+1;    
end

save ('Libri_features.mat','FRR','TSR','-append');
